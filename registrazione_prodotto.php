    ...
    <body>
        ...
        <div class="w3-bar-block w3-animate-left sidebar" style="display:none;z-index:5;" id="mySidebar">
            ...
            <div id="demoAcc" class="w3-hide w3-card href-accordion">
                ...
                <a href="registrazione_prodotto.php" class="w3-bar-item w3-button elementoAccordion bottoneCliccato">Registrazione nuovo prodotto</a>
        ...
        <div>
            <button class="w3-button  w3-xxlarge" onclick="w3_open()"  align="left">&#9776;</button><span class="idPersonale" style="right:0">
                ...
                ?></span>
			<center>
            <div class="w3-container"> <h1 style="text-align: center;">Prodotto</h1>

                <form method="post" action="javascript:loadDoc();">
                    <table>
                        <tr>
                            <td>Nome<span style="color: #990000;">*</span>:</td><td><input type="text" id="nome" maxlength="20"  placeholder="Inserire un nome" required></td>
                        </tr>
                        <tr>
                            <td>Costo(€)<span style="color: #990000;">*</span>:</td><td><input id="costo" type="number" min="0" max="10000.00" step="0.01" value="0" required></td>
                        </tr>
                        <tr>
                            <td>Categoria<span style="color: #990000;">*</span>:</td><td>
                                <select id="categoria" required>
                                    <option id="0" value="0">Scegliere una categoria</option>
                                    <?php
                                    // chiamata alla funzione di connessione
                                    $conn = connetti();
                        ...
                        <tr>
                            <td>Percentuale sconto<span style="color: #990000;">*</span>:</td><td><input id="percsconto" type="number" min="0" max="100.00" step="0.01" value="0" required>%</td>
                        </tr>
                        <tr>
                            <td>Aliquota IVA<span style="color: #990000;">*</span>:</td><td><input id="iva" type="number" min="0" max="100.00" step="0.01" value="0" required>%</td>
                        </tr>
                        <tr>
                            <td>Descrizione:</td><td> <textarea rows="4" cols="30" id="descrizione"  placeholder="Inserire una descrizione"></textarea></td>
                        </tr>
                        <tr>
        ...
        <script>
            function loadDoc() {
                if (document.getElementById("categoria").value != 0) {
                    ...
                    xhttp.onreadystatechange = function () {
                        if (this.readyState == 4 && this.status == 200) {
                            ...
                            if (risp == "Registrazione effettuata correttamente.") {
                                ...
                                document.getElementById("percsconto").value = "0";
                    ...
                    var percsconto = document.getElementById("percsconto").value;
                    var iva = document.getElementById("iva").value;
                    var descrizione = document.getElementById("descrizione").value;

                    query = "INSERT INTO prodotto (nome, costo, fk_id_categoria, percentuale_sconto, aliquota_da_aggiungere, descrizione) VALUES ('" + nome + "', '" + costo + "', '" + categoria + "', '" + percsconto + "', '" + iva + "', '" + descrizione + "')";
