    ...
    <body>
        ...
        <div class="w3-bar-block w3-animate-left sidebar" style="display:none;z-index:5;" id="mySidebar">
            ...
            <div id="demoAcc" class="w3-hide w3-card  href-accordion">
                <a href="registrazione_cliente.php" class="w3-bar-item w3-button elementoAccordion  bottoneCliccato">Registrazione cliente</a>
        ...
        <div>
            ...
            <div class="w3-container">
                <h1 style="text-align: center;">Registrazione cliente</h1>
                            ...
                            <tr>
                                <td>
                                    <table>
                                        ...
                                        <tr><td>Cognome<span style="color: #990000;">*</span>:</td> <td><input type="text" name="cognome" placeholder="Inserire cognome" maxlength="20" required></td></tr>
                                        <tr><td>Data di nascita<span style="color: #990000;">*</span>:</td> <td><input type="date" name="nascita"  min="1900-01-01" max="2002-01-01" required></td></tr>
                                        ...
                                        <tr><td>Telefono<span style="color: #990000;">*</span>:</td> <td><input type="int" name="tel" placeholder="Inserire numero di tel" maxlength="10" required></td></tr>
                                        <tr><td>Email:</td> <td><input type="email" name="email" placeholder="Inserire email (opzionale)" maxlength="30"></td></tr>
                                    </table>	
                                </td>
                                <td>
                                    <table>
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (isset($_POST['submit']) && ($control > $y)) {
                ...
                if ($conn->query($qry)) {
                    ...
                    //registro il cliente
                    $qry = "INSERT INTO cliente (nome, cognome,codice_fiscale ,data_nascita,telefono,email) VALUES ('$nome', '$cognome', '$codF', '$nascita','$telefono',NULLIF('$email',''))";
                    ...
                    if (!$conn->query($qry)) {
                        ...
                        echo "<script> window.location.replace('registrazione_cliente.php') </script>";
                    }
                } else {
