...
<html>
    <meta charset="UTF-8">
    <title>Registrazione marca</title>
    ...
    <body>
        ...
        <div class="w3-bar-block w3-animate-left sidebar" style="display:none;z-index:5;" id="mySidebar">
            ...
            <div id="demoAcc" class="w3-hide w3-card href-accordion">
                ...
                <a href="registrazione_marca.php" class="w3-bar-item w3-button elementoAccordion bottoneCliccato">Registrazione nuova marca</a>
		...
		<center>
            <div class="w3-container">
                ...
                <h1 style="text-align: center;">Marca</h1>
