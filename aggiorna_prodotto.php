...
<html>
    ...
    <body>
        ...
        <div class="w3-bar-block w3-animate-left sidebar" style="display:none;z-index:5;" id="mySidebar">
            ...
            <div id="demoAcc" class="w3-hide w3-card  href-accordion">
                <a href="aggiorna_prodotto.php" class="w3-bar-item w3-button elementoAccordion bottoneCliccato">Modifica percentuale sconto e aliquota prodotto</a>
        ...
        <div>
            ...
            <div class="w3-container">
                <h2>Aggiorna iva e sconto prodotto</h2>

                <form method="post" action="javascript:loadDoc();">
                    <table>
                        <tr>
                            <td>Categoria:</td><td>
                                <select id="categoria" onchange="cambia()" required>
                        ...
                        <tr>
                            <td>Prodotto:</td><td>
                                <select id="prodotto" onchange="cambiaValori()" required>
        ...
        <script>function loadDoc() {
                if ((document.getElementById("categoria").value != 0) && (document.getElementById("prodotto").value != "-1")) {
                    ...
                    var nome1 = document.getElementById("prodotto");
                    var nome = nome1.options[nome1.selectedIndex].text;
                    var iva = document.getElementById("iva").value;
                    var sconto = document.getElementById("sconto").value;

                    query = "UPDATE prodotto SET aliquota_da_aggiungere ='" + iva + "',percentuale_sconto ='" + sconto + "' WHERE nome = '" + nome + "' ";

                    xhttp.open("GET", "inserimentoDB.php?query=" + query, true);
                    xhttp.send();
                } else {
                    alert("scegli una categoria o prodotto");
                }
            }
            ...
            function cambia() {
                ...
                xhttp.onreadystatechange = function () {
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        var selectProd = document.getElementById("prodotto");
                        ...
                        for (var i = 1; i < arrayRisposta.length; i = i + 2) {
                            ...
                            option.value = arrayRisposta[i];//id_prodotto
            ...
            function cambiaValori() {
                ...
                var prod = document.getElementById("prodotto").value;

                query = "SELECT aliquota_da_aggiungere,percentuale_sconto FROM prodotto WHERE id_prodotto = '" + prod + "' ";
