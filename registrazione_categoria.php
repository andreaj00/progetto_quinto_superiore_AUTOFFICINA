...
<html>
    <meta charset="UTF-8">
    <title>Registrazione categoria</title>
    ...
    <body>
        ...
        <div class="w3-bar-block w3-animate-left sidebar" style="display:none;z-index:5;" id="mySidebar">
            ...
            <div id="demoAcc" class="w3-hide w3-card href-accordion">
                ...
                <a href="registrazione_categoria.php" class="w3-bar-item w3-button elementoAccordion bottoneCliccato">Registrazione nuova categoria</a>
		...
		<center>
            <div class="w3-container">
                ...
                <form method="post" action="javascript:loadDoc();">
                    <table>
                        <tr>
                            <td>Nome<span style="color: #990000;">*</span>:</td><td><input type="text" id="nome" maxlength="20"  placeholder="Inserire nome"required></td>
                        </tr>
                        <tr>
