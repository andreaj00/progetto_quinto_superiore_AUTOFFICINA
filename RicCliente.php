    ...
    <body>
        ...
        <div class="w3-bar-block w3-animate-left sidebar" style="display:none;z-index:5;" id="mySidebar">
            ...
            <div id="demoAcc" class="w3-hide w3-card  href-accordion">
                ...
                <a href="RicCliente.php" class="w3-bar-item w3-button elementoAccordion  bottoneCliccato">Modifica dati personali cliente</a>
        ...
        <div>
            ...
            <div class="w3-container">
                <h1>Modifica i dati di un cliente</h1>
                ...
                <form action="javascript:loadDoc();" method="post">
                    <table>
                        <tr><td>n° cliente:</td><td id='id_cliente'></td><td></td></tr>
                        ...
                        <tr><td>Telefono:</td><td><input id='telefono' maxlength="10" type='text' value='' required></td><td></td></tr>
                        <tr><td>Email:</td><td><input id='email' type='email' value='' required></td><td></td></tr>
                        <tr><td>Username:</td><td><input id='username' type='text' value='' required></td><td></td></tr>
                        ...
                        <tr><td colspan='2'><div align='right'><input type='submit' value='Invia' id='submit' class="bottone" disabled></div></td></tr>
        ...
        <script>
            function cerca() {
                if (document.getElementById("codice_fiscale_ricerca").value != 0) {
                    ...
                    xhttp.onreadystatechange = function () {
                        if (this.readyState == 4 && this.status == 200) {
                            ...
                            if (arrayRisposta[1]) {
                                ...
                                document.getElementById("username").value = arrayRisposta[7];
                                document.getElementById("id_cliente").innerHTML = arrayRisposta[8];
                                //abilito il pulsante invia
                                document.getElementById("submit").disabled = false;
                            } else {
                                alert("nessun cliente con questo codice fiscale");
                            }
                    ...
                    query = "SELECT nome,cognome,codice_fiscale,data_nascita,telefono,email,username,id_cliente FROM cliente,registrazione_cliente WHERE cliente.id_cliente=registrazione_cliente.fk_id_cliente AND codice_fiscale='" + codice_fiscale + "'";

                    xhttp.open("GET", "ricercaCombo.php?query=" + query + "&nColonne=" + 8, true);
                    xhttp.send();
                } else {
            ...
            function loadDoc() {
                if ((document.getElementById("password2").value == document.getElementById("password3").value)) {
                    ...
                    var id_cliente = document.getElementById("id_cliente").innerHTML;
                    xhttp.onreadystatechange = function () {
                        if (this.readyState == 4 && this.status == 200) {
                            //uso il trim che elimina gli sazi e gli a capo
                ...
                if ((document.getElementById("password2").value == document.getElementById("password3").value)) {
                    ...
                    xhttp.onreadystatechange = function () {
                        if (this.readyState == 4 && this.status == 200) {
                            ...
                            var risp = this.responseText.trim();
                            alert(this.responseText.trim());
                            if (risp === "Modifica effettuata correttamente.") {
