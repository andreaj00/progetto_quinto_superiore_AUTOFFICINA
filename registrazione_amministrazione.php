...
<html>
    <meta charset="UTF-8">
    <title>Registrazione Amministrazione</title>
    ...
    <body>
        ...
        <div class="w3-bar-block w3-animate-left sidebar" style="display:none;z-index:5;" id="mySidebar">
            ...
            <div id="demoAcc" class="w3-hide w3-card  href-accordion">
                ...
                <a href="registrazione_amministrazione.php" class="w3-bar-item w3-button elementoAccordion bottoneCliccato">Registrazione amministrazione</a>
            </div>
        ...
        <div>
            ...
            <div class="w3-container">
                <h1 style="text-align: center;">Registrazione Amministrazione</h1>
                            ...
                            <tr>
                                        ...
                                        <tr>
                                            <td>
                                                <table>
                                                    ...
                                                    <tr><td>Username<span style="color: #990000;">*</span>:</td> <td><input type="text" name ="Username" placeholder="inserire Username" maxlength="30" required></td></tr>
                                                    <tr><td>Password<span style="color: #990000;">*</span>:</td> <td><input type="password" name="pass" id="pass" placeholder="inserire Pasword" minlength="5" maxlength="32" required></td></tr>
                                                    <tr><td> Conferma password<span style="color: #990000;">*</span>:</td> <td><input type="password" name="confPass" id="confPass" placeholder="inserire Pasword" minlength="5" maxlength="32" onchange="controllaPass()" required></td></tr>
                                                </table>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <td>
                                    <table>
                                        ...
                                        <tr><td style="margin: 10px; padding: 25px;"></td></tr>
                                        <tr><td><input type="checkbox" onclick="visibilitaPassword()">Mostra password</td></tr>
                                        <tr><td><input type="checkbox" onclick="visibilitaPassword2()">Mostra password</td></tr>
                                    </table>
                                </td>																			
                            </tr>
                            <tr>
        ...
        <script>
            function controllaPass() {
                ...
                if (confPass != pass) {
                    alert("LE 2 PASSWORD DEVONO COINCIDERE (se invii dovrai inserire tutti i dati di nuovo)");
                }
            }
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $control = $y2 - 17;
            if (isset($_POST['submit']) && ($confPass == $password)) {
                if ($control > $y) {
                    ...
                    if ($conn->query($qry)) {
                        ...
                        //registro il cliente
                        $qry = "INSERT INTO amministrazione (nome, cognome,codice_fiscale ,data_nascita,fk_id_localita,telefono,email) VALUES ('$nome', '$cognome', '$codF', '$nascita','$id_localita','$telefono','$email')";
                    ...
                    $id_Amministrazione = $conn->insert_id;
                    $password = md5($password);
                    $qry = "INSERT INTO registrazione_amministrazione (username,password,fk_id_amministrazione) VALUES ('$username','$password','$id_Amministrazione')";
                    if (!$conn->query($qry)) {
                        //dato duplicato 
                        if ($conn->errno === 1062) {
                            //creo il messaggio di errore
                        ...
                        echo "<script> window.location.replace('registrazione_amministrazione.php') </script>";
                    }
                } else {
                    echo "Devi essere maggiorenne";
                }
            } else {
